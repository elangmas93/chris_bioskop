            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="#" class="navbar-brand">
                  <div class="brand-text brand-big"><span>Bioskop_Chris</span></div>
                  <div class="brand-text brand-small">Bioskop_Chris</div></a>
            ...
            <li>
                ...
                <?php 
                    if ($this->session->userdata('level') == 'admin') {
                        ...
                        <li>
                          <a href="'.base_url('index.php/Bioskop').'">
                              <i class="fa fa-film"></i>
                              <span>Bioskop</span>
                          </a>
                        </li>
                        <li>
                          <a href="'.base_url('index.php/Film').'">
                              <i class="fa fa-film"></i>
                              <span>Films</span>
                          </a>
                        </li>
                        <li>
                          <a href="'.base_url('index.php/Tayang').'">
